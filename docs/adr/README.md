...
| [0032](0032-auth-domain-types.md) | Auth domain types (`Cookie`/`CookieJar`/`MasterToken`) + `AuthTokens` runway | Proposed |
| [0033](0033-auth-consolidation-policy.md) | `_auth` consolidation policy — sanctioned-merge ceilings + function-granular write boundary | Proposed |
